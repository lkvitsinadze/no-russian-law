<template>
  <TheSection class="mb-4">
    ...
    <p class="pl-3 border-l-4 border-red-500 mb-4">
      ...
      მტკიცებულების ქონა ერთადერთი იარაღია თქვენს ხელში სიმართლის საჩვენებლად. უკეთესია, თუ ჩანაწერი ასახავს თქვენი
      დაკავების გადაწყვეტილების მომენტსა და მანამდე სიტუაციას გარშემო. ეს დაგეხმარებათ გადაწყვეტილების უკანონობის
      საჩვენებლად.
      დაკავების შემდეგ, უფლება გაქვთ(!) ისარგებლოთ საკუთარი ტელეფონით, შეატყობინოთ დაკავების შესახებ ოჯახის წევრს ან
      ნებისმიერ პირს (მაგალითად, გადაყვანის პროცესში). თუ პოლიცია გადაწყვეტს, რომ ჩამოგართვათ ტელეფონი და სხვა ნივთები,
